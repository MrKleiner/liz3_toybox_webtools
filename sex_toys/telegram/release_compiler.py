...
file = open("src/telegram_liz3_tools.js")
...
thefile = open("src/telegram_liz3_tools.js").read()
# print(thefile)
...
l3css = open("src/telegram_liz3_tools_css.css").read()
...
if search('// ==/UserScript==', thefile):
    ...
    for i, j in enumerate(linez):
        if 'window.liz3_css_64' in j:
            # print('found req index')
            print(i)
            uscriptend_index = i
else:
...
# write js file
with open("telegram_liz3_tools_r.js", "w") as txt_file:
    for line in linez:
